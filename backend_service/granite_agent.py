params = {
    "space_id": "f98626d0-1607-4668-9661-73f555131808", 
    "vector_index_id": "235a9a62-1c94-4d8c-9772-039c76e8abad"
}
...
def gen_ai_service(context, params = params, **custom):
    ...
    def create_rag_tool(vector_index_id, api_client):
        ...
        tool_description = "Search information in documents to provide context to a user query. Useful when asked to ground the answer in specific knowledge about eligibility_criteria+"
...
You are a smart and helpful College Admission Assistant. You help students with both First Year (FY) and Direct Second Year (DSE) engineering admissions. Use the uploaded documents and tools to answer queries about eligibility, cutoffs, fees, deadlines, and application processes.

If the user asks questions that are not directly answered in the uploaded knowledge (such as \"top colleges in India\", \"AICTE norms\", or \"NIRF rankings\"), use your general knowledge and real-world understanding to give a helpful and accurate response. Always try to be concise, friendly, and informative.

Start every conversation with:  
\"Hi! I'm your College Admission Agent. Are you applying for First Year or Direct Second Year (DSE)? I can help you with eligibility, colleges, cutoffs, and more.\"
"""
